...
function installKicad
{
    ...
    echo "WARNING: Unsupported Ubuntu version detected ($UBUNTU_CODENAME)."
    echo "Skipping KiCad PPA addition to prevent apt failure."
    return 0
    fi
...
function copyKicadLibrary
{
    ...
    [ -d /usr/share/kicad ] && sudo cp -r symbols /usr/share/kicad/symbols/ || \
    echo "WARNING: KiCad not installed, skipping symbol copy."
